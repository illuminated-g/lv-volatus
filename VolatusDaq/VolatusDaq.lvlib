...
<Library LVVersion="20008000">
	...
	<Item Name="Data Types" Type="Folder">
		<Item Name="DAQ Type.ctl" Type="VI" URL="../DAQ Type.ctl"/>
		<Item Name="Seq Action Type.ctl" Type="VI" URL="../Seq Action Type.ctl"/>
		<Item Name="Sequence Action.ctl" Type="VI" URL="../Sequence Action.ctl"/>
		<Item Name="Sequence.ctl" Type="VI" URL="../Sequence.ctl"/>
		<Item Name="Signal Type.ctl" Type="VI" URL="../Signal Type.ctl"/>
	</Item>
	<Item Name="DaqControl.lvclass" Type="LVClass" URL="../DaqControl/DaqControl.lvclass"/>
</Library>
